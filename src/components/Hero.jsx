      ...
      <div className="relative z-10 container mx-auto px-6 py-16">
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[85vh]">
          ...
          <div className={`space-y-8 transform transition-all duration-700 ease-out ${isAnimating ? 'opacity-0 translate-x-[-50px]' : 'opacity-100 translate-x-0'}`}>
            ...
            {/* Enhanced Badge */}
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-orange-100 to-amber-100 rounded-full border-2 border-orange-200 shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            {/* Title */}
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-gray-900 to-orange-600 bg-clip-text text-transparent leading-tight">
              {currentData.title}
            </h1>
          ...
          <div className="relative">
            <div className={`relative transform transition-all duration-700 ease-out ${isAnimating ? 'opacity-0 translate-x-[50px] scale-95' : 'opacity-100 translate-x-0 scale-100'}`}>
              ...
              <div className="relative group">
                ...
                <div className="relative bg-white/95 backdrop-blur-sm rounded-3xl p-8 shadow-2xl transform group-hover:scale-105 group-hover:-translate-y-2 transition-all duration-500 border border-orange-100">
                  <img
                    src={currentData.img}
                  ...
                  {/* Enhanced Price Tag */}
                  <div className="absolute bottom-4 left-4 bg-white/95 backdrop-blur-sm px-6 py-4 rounded-2xl shadow-xl border border-orange-100">
