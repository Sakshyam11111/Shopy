...
const Women = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-purple-50 py-12 lg:py-20 relative overflow-hidden">
            ...
            >
                <motion.div
                    className="absolute -top-40 -right-40 w-80 h-80 bg-rose-200 rounded-full mix-blend-multiply filter blur-xl"
                    animate={{ opacity: [0.5, 0.7, 0.5] }}
                    transition={{ repeat: Infinity, duration: 4 }}
                />
                <motion.div
                    className="absolute -bottom-40 -left-40 w-80 h-80 bg-pink-200 rounded-full mix-blend-multiply filter blur-xl"
                    animate={{ opacity: [0.5, 0.7, 0.5] }}
                    transition={{ repeat: Infinity, duration: 4, delay: 2 }}
                />
                <motion.div
                    className="absolute top-40 left-40 w-80 h-80 bg-purple-200 rounded-full mix-blend-multiply filter blur-xl"
                    animate={{ opacity: [0.5, 0.7, 0.5] }}
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    <motion.div
                        className="inline-flex items-center gap-2 px-4 py-2 bg-rose-100/80 rounded-full mb-4"
                            ...
                            >
                                ...
                                <div className="relative h-80 lg:h-96 overflow-hidden">
                                    ...
                                    >
                                        {/* Wishlist */}
                                        <motion.button
                                            className="w-10 h-10 bg-white/90 hover:bg-rose-500 text-gray-600 hover:text-white rounded-full flex items-center justify-center shadow-lg backdrop-blur-sm"
                                            variants={buttonVariants}
                                            whileHover="hover"
                                            whileTap="tap"
                                        >
                                        ...
                                        {/* Quick View */}
                                        <motion.button
                                            className="w-10 h-10 bg-white/90 hover:bg-pink-500 text-gray-600 hover:text-white rounded-full flex items-center justify-center shadow-lg backdrop-blur-sm"
                                            variants={buttonVariants}
                                            whileHover="hover"
                                            whileTap="tap"
                                        >
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        {/* Add to Cart Button */}
                                        <motion.button
                                            className="group/btn bg-gradient-to-r from-rose-500 to-pink-500 text-white rounded-full p-3 shadow-lg"
                                            variants={buttonVariants}
                                            whileHover="hover"
                                            whileTap="tap"
                                        >
                                ...
                                <motion.div
                                    className="absolute inset-0 bg-gradient-to-t from-rose-500/10 to-transparent rounded-3xl"
                                    initial={{ opacity: 0 }}
                                    whileHover={{ opacity: 1 }}
                                    transition={{ duration: 0.3 }}
                                />
                ...
                >
                    <div className="inline-block p-8 bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-rose-100">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            <motion.button
                                className="group relative px-8 py-4 bg-gradient-to-r from-rose-600 via-pink-600 to-purple-600 text-white font-bold rounded-full shadow-xl overflow-hidden"
                                variants={buttonVariants}
                                whileHover="hover"
                                whileTap="tap"
                            >
                                ...
                                <motion.div
                                    className="absolute inset-0 bg-gradient-to-r from-purple-600 to-rose-600"
                                    initial={{ opacity: 0 }}
                                    whileHover={{ opacity: 1 }}
                                    transition={{ duration: 0.3 }}
                                />
                            ...
                            <motion.button
                                className="px-8 py-4 bg-white border-2 border-rose-300 text-rose-600 font-bold rounded-full"
                                variants={buttonVariants}
                                whileHover="hover"
                                whileTap="tap"
                            >
